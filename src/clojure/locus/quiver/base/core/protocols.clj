(ns locus.quiver.base.core.protocols
...
; Unary quivers
(derive :locus.base.logic.structure.protocols/structured-function ::structured-nary-quiver)
(derive :locus.base.logic.structure.protocols/set-function ::nary-quiver)
