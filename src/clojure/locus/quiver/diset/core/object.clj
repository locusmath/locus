(ns locus.quiver.diset.core.object
...
(derive Diset :locus.quiver.base.core.protocols/diset)

(defmethod print-method Diset [^Diset v ^java.io.Writer w]
  (.write w (.toString v)))

; Accessors for the elements of disets
(defmethod get-set :locus.quiver.base.core.protocols/diset
  [diset n]
...
(defmethod get-function :locus.quiver.base.core.protocols/diset
  [diset [a b]]
...
(defmethod underlying-diset :locus.quiver.base.core.protocols/structured-nary-quiver
  [coll]
...
(defmethod image
  [:locus.quiver.base.core.protocols/diset :locus.base.logic.core.set/universal]
  [diset coll]
