(ns locus.quiver.binary.algebraic.object
...
(derive ABQuiver :locus.quiver.base.core.protocols/thin-quiver)
...
(defmethod to-algebraic-binary-quiver :locus.base.logic.structure.protocols/transformation
  [func]
...
(defmethod to-algebraic-binary-quiver :locus.base.logic.core.set/universal
  [rel]
