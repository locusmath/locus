(ns locus.quiver.ternary.core.object
...
(derive TernaryQuiver :locus.quiver.base.core.protocols/ternary-quiver)
...
(defmethod nth-component :locus.quiver.base.core.protocols/ternary-quiver
  [quiver edge i]
...
(defmethod get-set :locus.quiver.base.core.protocols/ternary-quiver
  [quiver x]
...
(defmethod get-function :locus.quiver.base.core.protocols/ternary-quiver
  [quiver x]
...
(defmethod product :locus.quiver.base.core.protocols/ternary-quiver
  [& quivers]

  (apply ternary-quiver-product quivers))

(defmethod coproduct :locus.quiver.base.core.protocols/ternary-quiver
  [& quivers]
...
(defmethod image
  [:locus.quiver.base.core.protocols/ternary-quiver :locus.base.logic.core.set/universal]
  [quiver coll]
...
(defmethod domain-binary-relation :locus.quiver.base.core.protocols/ternary-quiver
  [ternary-quiver]
...
(defmethod ternary-quiver? :locus.quiver.base.core.protocols/ternary-quiver
  [quiv] true)
...
(defmethod thin-ternary-quiver? :locus.quiver.base.core.protocols/thin-ternary-quiver
  [quiv] true)
...
(defmethod at-quiver? :locus.quiver.base.core.protocols/at-quiver
  [quiv] true)
