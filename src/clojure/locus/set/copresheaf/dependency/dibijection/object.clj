(ns locus.set.copresheaf.dependency.dibijection.object
...
(derive Dibijection :locus.set.copresheaf.structure.core.protocols/structured-difunction)
...
(defmethod to-dibijection :locus.set.copresheaf.structure.core.protocols/difunction
  [func]
