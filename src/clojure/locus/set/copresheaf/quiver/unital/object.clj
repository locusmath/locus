(ns locus.set.copresheaf.quiver.unital.object
...
(derive ::unital-quiver :locus.set.copresheaf.structure.core.protocols/structured-unital-quiver)
...
(defmethod to-unital-quiver :locus.set.logic.core.set/universal
