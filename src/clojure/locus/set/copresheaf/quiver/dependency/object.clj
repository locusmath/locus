(ns locus.set.copresheaf.quiver.dependency.object
  (:require [locus.set.logic.core.set :refer :all]
            [locus.set.logic.limit.product :refer :all]
            [locus.set.logic.sequence.object :refer :all]
            [locus.con.core.setpart :refer :all]
            [locus.con.core.object :refer [projection restrict-partition]]
...
(derive ::dependency-quiver :locus.set.copresheaf.structure.core.protocols/structured-dependency-quiver)
...
(defmethod to-dependency-quiver :locus.set.logic.core.set/universal
