(ns locus.set.copresheaf.quiver.permutable.object
  (:require [locus.set.logic.core.set :refer :all]
            [locus.set.logic.limit.product :refer :all]
            [locus.set.logic.sequence.object :refer :all]
            [locus.con.core.setpart :refer :all]
            [locus.con.core.object :refer [restrict-partition projection partitionize-family]]
...
(derive ::permutable-quiver :locus.set.copresheaf.structure.core.protocols/structured-permutable-quiver)
...
(defmethod to-permutable-quiver :locus.set.logic.core.set/universal
  [coll]
