(ns locus.set.copresheaf.incidence.core.object
...
(derive Span :locus.set.logic.structure.protocols/structured-set)
...
(defmethod to-span :locus.set.logic.core.set/universal
