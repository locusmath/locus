(ns locus.set.copresheaf.topoi.copresheaf.object
  ...
  (:import (locus.set.quiver.binary.core.morphism MorphismOfQuivers)
           ...
           (locus.set.tree.two_quiver.core.object TwoQuiver)
           (locus.set.tree.two_quiver.globular.object TwoGlobularSet)
           (locus.set.tree.two_quiver.path.object PathQuiver)
