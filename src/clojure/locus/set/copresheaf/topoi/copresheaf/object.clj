(ns locus.set.copresheaf.topoi.copresheaf.object
  (:require [locus.set.logic.core.set :refer :all]
            ...
            [locus.set.copresheaf.quiver.dependency.morphism :refer :all]
            ...
            [locus.set.tree.two-quiver.globular.object :refer :all]
            [locus.set.copresheaf.galois.copresheaf.object :refer :all]
            [locus.set.quiver.nary.core.object :refer :all]
            [locus.set.quiver.nary.core.morphism :refer :all])
  (:import (locus.set.quiver.binary.core.morphism MorphismOfQuivers)
           (locus.set.copresheaf.quiver.permutable.morphism MorphismOfPermutableQuivers)
           (locus.set.copresheaf.quiver.unital.morphism MorphismOfUnitalQuivers)
           (locus.set.copresheaf.quiver.dependency.morphism MorphismOfDependencyQuivers)
           (locus.set.action.global.object MSet)
           (locus.set.action.global.morphism EquivariantMap)
           (locus.set.quiver.ternary.core.morphism MorphismOfTernaryQuivers)
           (locus.set.copresheaf.two_quiver.core.object TwoQuiver)
           (locus.set.copresheaf.two_quiver.globular.object TwoGlobularSet)
           (locus.set.copresheaf.two_quiver.path.object PathQuiver)
           ...
           (locus.set.copresheaf.galois.copresheaf.object GaloisCopresheaf)
...
(defmethod index :locus.set.quiver.binary.core.object/quiver
  [quiver] t2*)
...
(defmethod index :locus.set.copresheaf.quiver.permutable.object/permutable-quiver
...
(defmethod index :locus.set.copresheaf.quiver.unital.object/unital-quiver
...
(defmethod index :locus.set.copresheaf.quiver.dependency.object/dependency-quiver
...
(defmethod index :locus.set.copresheaf.structure.core.protocols/ternary-quiver
  [ternary-quiver] t3*)
...
(defmethod index :locus.set.copresheaf.structure.core.protocols/partial-magmoid
  [obj] compositional-quiver-index-category)

(defmethod index :locus.set.copresheaf.structure.core.protocols/category
  [obj] compositional-unital-quiver-index-category)

(defmethod index :locus.set.copresheaf.structure.core.protocols/groupoid
...
(defmethod to-copresheaf :locus.set.copresheaf.structure.core.protocols/semigroupoid
  [semigroupoid] (make-compositional-quiver semigroupoid))

(defmethod to-copresheaf :locus.set.copresheaf.structure.core.protocols/category
  [category] (make-compositional-unital-quiver category))

(defmethod to-copresheaf :locus.set.copresheaf.structure.core.protocols/groupoid
