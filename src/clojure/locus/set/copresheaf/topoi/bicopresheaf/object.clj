(ns locus.set.copresheaf.topoi.bicopresheaf.object
  ...
  (:import (locus.set.copresheaf.topoi.copresheaf.object Copresheaf)
           (locus.set.copresheaf.topoi.copresheaf.morphism MorphismOfCopresheaves)))
...
(derive Bicopresheaf :locus.set.copresheaf.structure.core.protocols/structure-copresheaf)
