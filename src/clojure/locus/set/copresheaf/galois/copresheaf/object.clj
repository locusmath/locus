(ns locus.set.copresheaf.galois.copresheaf.object
...
(derive GaloisCopresheaf :locus.set.copresheaf.structure.core.protocols/structured-diset)
...
(defmethod to-galois-copresheaf :locus.set.logic.structure.protocols/invertible-set-function
  [func]
