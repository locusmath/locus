(ns locus.set.quiver.diset.core.morphism
  (:require [locus.set.logic.core.set :refer :all]
            [locus.set.logic.limit.product :refer :all]
            [locus.set.logic.sequence.object :refer :all]
            [locus.con.core.setpart :refer :all]
            [locus.set.mapping.general.core.object :refer :all]
            [locus.set.mapping.function.limit.product :refer :all]
...
(derive Difunction :locus.set.quiver.structure.core.protocols/difunction)
...
(defmethod visualize :locus.set.quiver.structure.core.protocols/morphism-of-nary-quivers
  [difunction]
