(ns locus.set.quiver.binary.core.object
...
(derive Quiver :locus.set.quiver.structure.core.protocols/quiver)
...
(defmethod get-set :locus.set.quiver.structure.core.protocols/quiver
  [quiver x]
...
(defmethod get-function :locus.set.quiver.structure.core.protocols/quiver
  [quiver x]
...
(defmethod nth-component :locus.set.quiver.structure.core.protocols/quiver
  [quiver edge i]
...
(defmethod to-quiver :locus.set.logic.structure.protocols/structured-function
  [func]
...
(defmethod to-quiver :locus.set.logic.core.set/universal
  [rel]
...
(defmethod image
  [:locus.set.quiver.structure.core.protocols/quiver :locus.set.logic.core.set/universal]
  [quiver coll]
...
(defmethod quiver? :locus.set.quiver.structure.core.protocols/quiver
  [quiv] true)
