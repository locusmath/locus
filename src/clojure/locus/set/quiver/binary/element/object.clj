(ns locus.set.quiver.binary.element.object
...
(derive QuiverObject :locus.set.logic.structure.protocols/element)
(derive QuiverMorphism :locus.set.logic.structure.protocols/element)

(defmethod wrap :locus.set.quiver.structure.core.protocols/structured-quiver
  [quiv [i v]]
