(ns locus.set.quiver.nary.core.object
...
(derive NaryQuiver :locus.set.quiver.structure.core.protocols/nary-quiver)
...
(defmethod to-nary-quiver :locus.set.quiver.structure.core.protocols/diset
  [diset]
...
(defmethod to-nary-quiver :locus.set.logic.structure.protocols/set-function
  [func]
...
(defmethod to-nary-quiver :locus.set.quiver.structure.core.protocols/quiver
  [quiver]
...
(defmethod to-nary-quiver :locus.set.quiver.structure.core.protocols/ternary-quiver
  [quiver]
...
(defmethod to-nary-quiver :locus.set.logic.core.set/universal
  [coll]
...
(defmethod image
  [:locus.set.quiver.structure.core.protocols/nary-quiver :locus.set.logic.core.set/universal]
  [quiver coll]
