(ns locus.set.quiver.relation.ternary.tr
...
; Moore's families of ternary relations
  ...
  (intersection
   ...
   (fn [rel]
     (= (intersection
         ...
         (let [intervals (betweenness-intervals rel)]
           (apply union (map power-set intervals))))
        (set
         (map
          (fn [[a b c]]
            (set (list a c)))
