(ns locus.set.quiver.relation.binary.sr
  (:require [clojure.set]
  ...
  (:import [locus.set.logic.core.set Universal SeqableUniversal]
           [locus.set.quiver.relation.binary.product CompleteRelation BinaryCartesianProduct]))
...
(derive SeqableRelation :locus.set.logic.core.set/universal)
