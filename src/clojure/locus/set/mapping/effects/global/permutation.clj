(ns locus.set.mapping.effects.global.permutation
...
(derive Permutation :locus.set.logic.structure.protocols/permutation)
...
(defmethod to-permutation :locus.set.logic.structure.protocols/invertible-set-function
  [func]
...
(defmethod to-permutation :locus.set.logic.structure.protocols/set-function
  [func]
