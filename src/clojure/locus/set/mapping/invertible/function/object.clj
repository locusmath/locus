(ns locus.set.mapping.invertible.function.object
...
(derive InvertibleFunction :locus.set.logic.structure.protocols/invertible-set-function)

; Conversion routines
(defmulti to-invertible-function type)

(defmethod to-invertible-function :locus.set.logic.structure.protocols/invertible-set-function
  [func] func)

(defmethod to-invertible-function :locus.set.logic.structure.protocols/set-function
  [func]
