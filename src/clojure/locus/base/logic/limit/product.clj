(ns locus.base.logic.limit.product
  (:require [clojure.set]
...
(derive ::cartesian-product :locus.base.logic.core.set/universal)
(derive ::cartesian-coproduct :locus.base.logic.core.set/universal)
...
(derive CartesianPower :locus.base.logic.limit.product/cartesian-product)
