(ns locus.base.partition.core.object
  (:require [locus.base.logic.core.set :refer :all]
            [locus.base.logic.limit.product :refer :all]
            [locus.base.logic.structure.protocols :refer :all]))

; Ontology of set partitions
(derive ::set-partition :locus.base.logic.structure.protocols/structured-set)
...
(defmethod substructure [SetPartition :locus.base.logic.core.set/universal]
  [^SetPartition a, coll]
