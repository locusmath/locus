(ns locus.base.effects.global.transformation
...
(derive Transformation :locus.base.logic.structure.protocols/transformation)
...
(defmethod to-transformation :locus.base.logic.structure.protocols/set-function
  [func]
