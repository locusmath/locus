(ns locus.elementary.triangle.core.morphism
...
(defn triangle-morphism-product
  [& morphisms]
...
(defn triangle-morphism-coproduct
  [& morphisms]
...
(defmethod product TriangleMorphism
  ...
  (apply triangle-morphism-product morphisms))

(defmethod coproduct TriangleMorphism
  [& morphisms]

  (apply triangle-morphism-coproduct morphisms))
