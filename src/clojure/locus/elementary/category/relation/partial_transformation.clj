...
; Relational partial transformations
(defn relational-partial-transformation
  ([rel] (relational-partial-transformation (vertices rel) rel))
  ([coll rel]
...
(defmethod to-partial-transformation :locus.elementary.copresheaf.core.protocols/bijection
  [bijection]

  (to-partial-transformation (underlying-function bijection)))
