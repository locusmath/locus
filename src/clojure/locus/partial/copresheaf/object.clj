...
(derive PartialCopresheaf :locus.set.copresheaf.structure.core.protocols/structure-copresheaf)
...
(defmethod to-partial-copresheaf :locus.set.logic.core.set/universal
  [coll]
